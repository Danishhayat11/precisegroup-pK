...
const CSV_TOTAL_RECEIVED_FORMULA = "Cash Recovered + Asset Realized \\u2212 Commission Paid";
const PDF_FOOTER_NOTE = "Total Received = Cash + Asset Realized \\u2212 Commission Paid";
const PDF_KEYWORD = "Total Received = Cash + Asset Realized \\u2212 Commission Paid";
