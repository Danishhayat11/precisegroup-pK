      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 pt-16">
        <div
          className="prose dark:prose-invert prose-lg md:prose-xl max-w-none
                     ...
                     prose-ul:text-muted-foreground prose-li:mb-4
        ...
        <div className="flex items-center justify-between">
          <div className="text-muted-foreground text-sm tracking-wider uppercase">Share this article</div>
          <div className="flex space-x-4">
            <button className="w-10 h-10 min-w-11 min-h-11 rounded-full border border-border text-foreground flex items-center justify-center hover:border-[var(--gold)] hover:text-[var(--gold)] transition-colors">
