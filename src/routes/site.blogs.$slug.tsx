    ...
    <article className="w-full bg-[var(--background)] min-h-screen text-[var(--foreground)] pb-24 relative overflow-hidden selection:bg-[var(--gold)] selection:text-black">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 pt-16">
        ...
        <div className="flex items-center justify-between">
          <div className="text-white/50 text-sm tracking-wider uppercase">Share this article</div>
          <div className="flex space-x-4">
            <button className="w-10 h-10 min-w-11 min-h-11 rounded-full border border-white/20 flex items-center justify-center hover:border-[var(--gold)] hover:text-[var(--gold)] transition-colors">
