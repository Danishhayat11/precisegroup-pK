...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-[11px] font-semibold tracking-wider transition-all select-none",
  {
    variants: {
      variant: {
        default:
          "border-transparent bg-primary/15 text-primary hover:bg-primary/25 backdrop-blur-md shadow-sm",
        secondary:
        ...
        outline:
          "text-foreground border-border/40 bg-white/5 dark:bg-black/10 backdrop-blur-md shadow-sm",
      },
    },
    defaultVariants: {
      variant: "default",
