...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background/80 backdrop-blur-3xl p-6 shadow-[0_0_60px_rgba(0,0,0,0.15)] border-border/60 transition ease-[cubic-bezier(0.16,1,0.3,1)] data-[state=closed]:duration-400 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Description ref={ref} className={cn("lead !text-sm", className)} {...props} />
));
