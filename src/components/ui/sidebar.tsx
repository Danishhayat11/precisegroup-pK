      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper flex min-h-svh w-full has-[[data-variant=inset]]:bg-white/40 dark:has-[[data-variant=inset]]:bg-black/40 has-[[data-variant=inset]]:backdrop-blur-3xl",
              className,
            )}
            ref={ref}
            {...props}
  ...
  (
    ...
    if (collapsible === "none") {
      return (
        <div
          className={cn(
            "flex h-full w-(--sidebar-width) flex-col bg-white/40 dark:bg-black/40 backdrop-blur-3xl border-r border-border/30 text-sidebar-foreground shadow-[1px_0_10px_rgba(0,0,0,0.03)]",
            className,
          )}
          ref={ref}
          {...props}
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-(--sidebar-width) bg-white/40 dark:bg-black/40 backdrop-blur-3xl p-0 text-sidebar-foreground [&>button]:hidden border-r border-sidebar-border/30 shadow-lg"
            style={
              {
    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-white/40 dark:bg-black/40 backdrop-blur-3xl border-r border-sidebar-border/30 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
...
const SidebarTrigger = React.forwardRef<
  ...
  Omit<React.ComponentProps<typeof Button>, "size" | "aria-label" | "aria-labelledby">
